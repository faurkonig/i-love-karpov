...
void PenDialog::openDialog(QString title, Pen * newPenPtr, bool isPixel)
{
...
void PenDialog::on_comboBoxStyle_activated(int index)
{
...
void PenDialog::on_spinBoxWeight_valueChanged(int arg1)
{
    // Обработчик изменения толщины карандаша
    thisPen.setWeight(arg1);
}


void PenDialog::on_pushButtonColor_clicked()
{
...
void PenDialog::on_buttonBox_accepted()
{
    // ОК
    *penPtr = thisPen;
    close();
...
void PenDialog::on_buttonBox_rejected()
{
    // Отмена
    close();
}
